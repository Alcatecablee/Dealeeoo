...
export default function EnhancedDealForm({ onCancel, onSuccess }: EnhancedDealFormProps) {
  ...
  return (
    ...
    <div className="md:col-span-2 flex flex-col gap-6">
      <div className="glass-card rounded-2xl shadow-xl bg-white/60 dark:bg-gray-900/70 backdrop-blur-lg p-6 text-gray-900 dark:text-gray-100 border border-white/20 dark:border-blue-900/30">
        <h3 className="font-bold text-lg mb-3 text-gradient-friendly">How It Works</h3>
        <ol className="space-y-2 pl-2">
          <li className="flex items-start gap-2"><span className="w-6 h-6 rounded-full bg-gradient-to-br from-friendly-blue to-friendly-purple text-white flex items-center justify-center font-bold mr-2">1</span>Fill in the deal details, including both buyer's and seller's email addresses.</li>
          <li className="flex items-start gap-2"><span className="w-6 h-6 rounded-full bg-gradient-to-br from-friendly-purple to-friendly-green text-white flex items-center justify-center font-bold mr-2">2</span>Both parties will receive unique links to view and manage the deal.</li>
          <li className="flex items-start gap-2"><span className="w-6 h-6 rounded-full bg-gradient-to-br from-friendly-green to-friendly-blue text-white flex items-center justify-center font-bold mr-2">3</span>The buyer confirms payment, and the seller confirms delivery to complete the deal.</li>
        </ol>
      </div>
      <div className="glass-card rounded-2xl shadow-xl bg-white/60 dark:bg-gray-900/70 backdrop-blur-lg p-6 text-gray-900 dark:text-gray-100 border border-white/20 dark:border-blue-900/30">
        <h3 className="font-bold text-lg mb-3 text-gradient-friendly">Security Tips</h3>
        <ul className="space-y-2 pl-2">
          <li className="flex items-start gap-2"><span className="text-yellow-500 mt-1">&#9888;</span>Keep your deal link private. Only share with the other party in your transaction.</li>
          <li className="flex items-start gap-2"><span className="text-yellow-500 mt-1">&#9888;</span>Be specific in your deal description to avoid misunderstandings.</li>
          <li className="flex items-start gap-2"><span className="text-yellow-500 mt-1">&#9888;</span>For high-value transactions, consider creating an account for extra protection.</li>
        </ul>
      </div>
      <div className="glass-card rounded-2xl shadow-xl bg-gradient-to-r from-blue-100/60 to-purple-100/60 dark:from-blue-900/40 dark:to-purple-900/40 backdrop-blur-lg p-4 text-gray-900 dark:text-gray-100 border border-white/20 dark:border-blue-900/30">
        <h4 className="font-semibold mb-1 text-gradient-friendly">Why trust us?</h4>
        <p className="text-sm">Our platform ensures transparency and security for both parties with real-time updates and secure transaction tracking.</p>
      </div>
    </div>
    </div>
  );
