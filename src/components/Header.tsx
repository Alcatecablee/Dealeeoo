    ...
    <header className={`bg-background border-b border-border sticky top-0 z-50 text-foreground transition-transform duration-300 ${showHeader ? 'translate-y-0' : '-translate-y-full'}`} style={{ willChange: 'transform' }}>
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex flex-1 justify-center space-x-6">
          ...
          <button onClick={() => handleNav('pricing')} className="text-muted-foreground hover:text-primary transition-colors flex items-center gap-1 focus:outline-none">
          ...
          <Sheet>
            ...
            <SheetContent className="bg-background text-foreground border-border backdrop-blur-md">
              <div className="flex flex-col space-y-6 pt-10">
                ...
                <button onClick={() => handleNav('pricing')} className="text-lg font-medium text-muted-foreground flex items-center gap-2 hover:text-primary transition-colors focus:outline-none">
